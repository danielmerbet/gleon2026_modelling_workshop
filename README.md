...
| 1 | `01b_era5_download.R`, `01c_prepare_vilar_data.R`, `01_data.R` | Data creation | Before the meeting |
...
| 7 | `07_validate_vilar.R` | Independent validation against Vilar site A (2023–2026) | 10 min |
...
│   └── vilar_temperature.csv   # tidy validation temperature soundings (generated)
...
**Banyoles temperature soundings** (`data/vilar_temperature.csv`, generated by `01c_prepare_vilar_data.R` from `data/new_data.xlsx`)  
